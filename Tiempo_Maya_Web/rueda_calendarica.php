  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        ...
        <div style="padding-top: 5px; padding-left: 31%;">
          <img src="<?php echo "img/nahuales/".$_SESSION['nahual_rcc'].".jpg";?>" width="200px" height="200px">
        </div>
      </div>
      <div class="col">
        <div class="section-header">
        ...
        <div style="padding-top: 5px; padding-left: 32%;">
          <img src="<?php echo "./img/energia/".$_SESSION['energia_rc'].".png";?>" width="200px" height="200px">
        </div>
      </div>
    </div>
    <br>
    <div class="row">
      <div class="col">
        ...
        <!-- Imagen -->
        <div style="padding-top: 5px; padding-left: 31%;">
          <img src="<?php echo "./img/nahuales/".$_SESSION['nahual_rc'].".jpg";?>" width="200px" height="200px">
        </div>
      </div>
      <div class="col">
        <div class="section-header">
